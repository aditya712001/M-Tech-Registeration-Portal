...
$work_1_experience_duration	 = $row['work_1_experience_duration'];
$work_1_nature_of_work	 = $row['work_1_nature_of_work'];
$work_1_current_job	 = $row['work_1_current_job'];
$work_2_experience_type	 = $row['work_2_experience_type'];
$work_2_organization_name	 = $row['work_2_organization_name'];
$work_2_position	 = $row['work_2_position'];
$work_2_from_date	 = $row['work_2_from_date'];
$work_2_to_date	 = $row['work_2_to_date'];
$work_2_experience_duration	 = $row['work_2_experience_duration'];
$work_2_nature_of_work	 = $row['work_2_nature_of_work'];
$work_2_current_job	 = $row['work_2_current_job'];
$work_3_experience_type	 = $row['work_3_experience_type'];
$work_3_organization_name	 = $row['work_3_organization_name'];
$work_3_position	 = $row['work_3_position'];
$work_3_from_date	 = $row['work_3_from_date'];
$work_3_to_date	 = $row['work_3_to_date'];
$work_3_experience_duration	 = $row['work_3_experience_duration'];
$work_3_nature_of_work	 = $row['work_3_nature_of_work'];
$work_3_current_job	 = $row['work_3_current_job'];
...
<option value="OBC" <?php if($personal_birth_category=="OBC") echo 'selected="selected"'; ?>>OBC(Non Creamy)</option>
                    ...
                    <div class="form-row mt-4">
                        <div class="col-sm-3 pb-3">
                            ...
                            <select class="form-control" name="work_1_experience_type" disabled>
                                <option value=''>Select</option>
                                <option value="Teaching" <?php if($work_1_experience_type=="Teaching") echo 'selected="selected"'; ?>>Teaching</option>
<option value="Research" <?php if($work_1_experience_type=="Research") echo 'selected="selected"'; ?>>Research</option>
<option value="Industry" <?php if($work_1_experience_type=="Industry") echo 'selected="selected"'; ?>>Industry</option>
<option value="Others" <?php if($work_1_experience_type=="Others") echo 'selected="selected"'; ?>>Others</option>
                            </select>
                        </div>
                        <div class="col-sm-3 pb-3">
                            <label for="exampleCtrl"><b>Organization Name</b></label>
                            <input type="text" class="form-control" id="exampleCtrl" name="work_1_organization_name" value="<?php echo $work_1_organization_name; ?>" disabled>
                        </div>
                        <div class="col-sm-3 pb-3">
                            <label for="exampleCtrl"><b>Position</b></label>
                            <input type="text" class="form-control" id="exampleCtrl" name="work_1_position" value="<?php echo $work_1_position; ?>" disabled>
                        </div>
                        <div class="col-sm-3 pb-3">
                            <label for="exampleCtrl"><b>From Date</b></label>
                            <input type="date" class="form-control" id="exampleCtrl" name="work_1_from_date" value="<?php echo $work_1_from_date; ?>" disabled>
                        </div>
                    ...
                    <div class="form-row mt-4">
                        <div class="col-sm-3 pb-3">
                            ...
                            <input type="date" class="form-control" id="exampleCtrl" name="work_1_to_date" value="<?php echo $work_1_to_date; ?>" disabled>
                        </div>
                        <div class="col-sm-3 pb-3">
                            <label for="exampleCtrl"><b>Experience Duration</b></label>
                            <input type="text" class="form-control" id="exampleCtrl" name="work_1_experience_duration" value="<?php echo $work_1_experience_duration; ?>" disabled>
                        </div>
                        <div class="col-sm-3 pb-3">
                            <label for="exampleCtrl"><b>Nature of Work</b></label>
                            <input type="text" class="form-control" id="exampleCtrl" name="work_1_nature_of_work" value="<?php echo $work_1_nature_of_work; ?>" disabled>
                        </div>
                        <div class="col-sm-3 pb-3">
                            <label for="exampleCtrl"><b>Current Job</b></label>
                            <select class="form-control" name="work_1_current_job" disabled>
                                <option value=''>Select</option>
                                <option value="Yes" <?php if($work_1_current_job=="Yes") echo 'selected="selected"'; ?>>Yes</option>
<option value="No" <?php if($work_1_current_job=="No") echo 'selected="selected"'; ?>>No</option>
                            </select>
                        </div>
                    </div>
                    <hr style="width: 100%; color: black; height: 1px; background-color:blue;" />
                    ...
                    <div class="form-row mt-4">
                        <div class="col-sm-3 pb-3">
                            <label for="exampleAccount"><b>Work Experience Type</b></label>
                            <select class="form-control" name="work_2_experience_type" disabled>
                                <option value=''>Select</option>
                                 <option value="Teaching" <?php if($work_2_experience_type=="Teaching") echo 'selected="selected"'; ?>>Teaching</option>
<option value="Research" <?php if($work_2_experience_type=="Research") echo 'selected="selected"'; ?>>Research</option>
<option value="Industry" <?php if($work_2_experience_type=="Industry") echo 'selected="selected"'; ?>>Industry</option>
<option value="Others" <?php if($work_2_experience_type=="Others") echo 'selected="selected"'; ?>>Others</option>
                            </select>
                        </div>
                        <div class="col-sm-3 pb-3">
                            <label for="exampleCtrl"><b>Organization Name</b></label>
                            <input type="text" class="form-control" id="exampleCtrl" name="work_2_organization_name" value="<?php echo $work_2_organization_name; ?>" disabled>
                        </div>
                        <div class="col-sm-3 pb-3">
                            <label for="exampleCtrl"><b>Position</b></label>
                            <input type="text" class="form-control" id="exampleCtrl" name="work_2_position" value="<?php echo $work_2_position; ?>" disabled>
                        </div>
                        <div class="col-sm-3 pb-3">
                            <label for="exampleCtrl"><b>From Date</b></label>
                            <input type="date" class="form-control" id="exampleCtrl" name="work_2_from_date" value="<?php echo $work_2_from_date; ?>" disabled>
                        </div>
                    ...
                    <div class="form-row mt-4">
                        <div class="col-sm-3 pb-3">
                            <label for="exampleCtrl"><b>To Date</b></label>
                            <input type="date" class="form-control" id="exampleCtrl" name="work_2_to_date" value="<?php echo $work_2_to_date; ?>" disabled>
                        </div>
                        <div class="col-sm-3 pb-3">
                            <label for="exampleCtrl"><b>Experience Duration</b></label>
                            <input type="text" class="form-control" id="exampleCtrl" name="work_2_experience_duration" value="<?php echo $work_2_experience_duration; ?>" disabled>
                        </div>
                        <div class="col-sm-3 pb-3">
                            <label for="exampleCtrl"><b>Nature of Work</b></label>
                            <input type="text" class="form-control" id="exampleCtrl" name="work_2_nature_of_work" value="<?php echo $work_2_nature_of_work; ?>" disabled>
                        </div>
                        <div class="col-sm-3 pb-3">
                            <label for="exampleCtrl"><b>Current Job</b></label>
                            <select class="form-control" name="work_2_current_job" disabled>
                                <option value=''>Select</option>
                                <option value="Yes" <?php if($work_2_current_job=="Yes") echo 'selected="selected"'; ?>>Yes</option>
<option value="No" <?php if($work_2_current_job=="No") echo 'selected="selected"'; ?>>No</option>
                            </select>
                        </div>
                    </div>
                    <hr style="width: 100%; color: black; height: 1px; background-color:blue;" />
                    ...
                    <div class="form-row mt-4">
                        <div class="col-sm-3 pb-3">
                            <label for="exampleAccount"><b>Work Experience Type</b></label>
                            <select class="form-control" name="work_3_experience_type" disabled>
                                <option value=''>Select</option>
                                 <option value="Teaching" <?php if($work_3_experience_type=="Teaching") echo 'selected="selected"'; ?>>Teaching</option>
<option value="Research" <?php if($work_3_experience_type=="Research") echo 'selected="selected"'; ?>>Research</option>
<option value="Industry" <?php if($work_3_experience_type=="Industry") echo 'selected="selected"'; ?>>Industry</option>
<option value="Others" <?php if($work_3_experience_type=="Others") echo 'selected="selected"'; ?>>Others</option>
                            </select>
                        </div>
                        <div class="col-sm-3 pb-3">
                            <label for="exampleCtrl"><b>Organization Name</b></label>
                            <input type="text" class="form-control" id="exampleCtrl" name="work_3_organization_name" value="<?php echo $work_3_organization_name; ?>" disabled>
                        </div>
                        <div class="col-sm-3 pb-3">
                            <label for="exampleCtrl"><b>Position</b></label>
                            <input type="text" class="form-control" id="exampleCtrl" name="work_3_position" value="<?php echo $work_3_position; ?>" disabled>
                        </div>
                        <div class="col-sm-3 pb-3">
                            <label for="exampleCtrl"><b>From Date</b></label>
                            <input type="date" class="form-control" id="exampleCtrl" name="work_3_from_date" value="<?php echo $work_3_from_date; ?>" disabled>
                        </div>
                    ...
                    <div class="form-row mt-4">
                        <div class="col-sm-3 pb-3">
                            <label for="exampleCtrl"><b>To Date</b></label>
                            <input type="date" class="form-control" id="exampleCtrl" name="work_3_to_date" value="<?php echo $work_3_to_date; ?>" disabled>
                        </div>
                        <div class="col-sm-3 pb-3">
                            <label for="exampleCtrl"><b>Experience Duration</b></label>
                            <input type="text" class="form-control" id="exampleCtrl" name="work_3_experience_duration" value="<?php echo $work_3_experience_duration; ?>"  disabled>
                        </div>
                        <div class="col-sm-3 pb-3">
                            <label for="exampleCtrl"><b>Nature of Work</b></label>
                            <input type="text" class="form-control" id="exampleCtrl" name="work_3_nature_of_work" value="<?php echo $work_3_nature_of_work; ?>" disabled>
                        </div>
                        <div class="col-sm-3 pb-3">
                            <label for="exampleCtrl"><b>Current Job</b></label>
                            <select class="form-control" name="work_3_current_job" disabled>
                                <option value=''>Select</option>
                                <option value="Yes" <?php if($work_3_current_job=="Yes") echo 'selected="selected"'; ?>>Yes</option>
<option value="No" <?php if($work_3_current_job=="No") echo 'selected="selected"'; ?>>No</option>
                            </select>
                        </div>
                    </div>
                    <hr style="width: 100%; color: black; height: 1px; background-color:blue;" />
...
<option value="Geology and Geophysics (GG)" <?php if($gate_paper_code=="Geology and Geophysics (GG)") echo 'selected="selected"'; ?>>GeologyandGeophysics (GG)</option>
